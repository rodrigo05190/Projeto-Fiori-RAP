		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Ação Urgente",
									"targetURL": "#rodrigodesafio5paprovacaosolicitacao-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"rodrigodesafio5paprovacaosolicitacao-display": {
								"semanticObject": "rodrigodesafio5paprovacaosolicitacao",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=rodrigo.desafio5p.aprovacaosolicitacao",
									"url": sap.ui.require.toUrl("rodrigo/desafio5p/aprovacaosolicitacao")
								}
							}
						}
					}
